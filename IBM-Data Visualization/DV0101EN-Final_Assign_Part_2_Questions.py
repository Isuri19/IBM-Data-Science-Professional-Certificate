...
def update_output_container(dropdown_stat, year):
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.pie(average_sales, values='Automobile_Sales',
         names='Vehicle_Type', title='Average number of vehicles sold by vehicle type over Recession Period'))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec, values='Advertising_Expenditure',
         names='Vehicle_Type', title='Average advertising expenditure by vehicle type over Recession Period'))
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                             
    elif (dropdown_stat == 'Yearly Statistics') :
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart3 = dcc.Graph( figure=px.bar(avr_vdata, x= 'Year', y='Automobile_Sales', color='Vehicle_Type', barmode= 'group',title='Average Vehicles Sold by Vehicle Type in the year {}'.format(year)))
